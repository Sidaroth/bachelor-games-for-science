...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta name="description" content="Bachelor Project, Games for Science, Gjøvik University College">
        <meta name="keywords" content="cms blog content managment system blogging">
        <title>Games for Science</title>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a class="brand" href="index.php">Games for Science</a>
    ...
    <div class="container">
        ...
        switch($id) {
            case "home"     : include('magneter.php');      break;
            ...
            default         : include('magneter.php');       break;
        }
